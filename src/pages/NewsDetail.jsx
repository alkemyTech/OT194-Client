	...
	return (
		<div className="flex flex-col mx-auto" style={{ maxWidth: '1200px' }} >
			...
			<div className="flex flex-col px-5 md:px-8">
				<h2 className="font-sans">{details ? details?.titulo : 'Se ha producido un error inesperado'}</h2>
				<p className="m-0 p-0">{details ? details?.descripcion : 'La novedad solicitad no fue encontrada.'}</p>
